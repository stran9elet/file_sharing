...
#define MSG_PONG 5 // to check if a node is online
#define MSG_REHASH 6 // sent by a latest joined node to all its closest k nodes, to rehash their hash keys, and send some keys to me